// TINYGO: Removed https support
// TINYGO: Removed closeIdleTransport interface
...
type Server struct {
	...
	// TINYGO: Removed TLS and certificate properties.
...
func (s *Server) Close() {
	...
	// TINYGO: Removed idle connection closing
